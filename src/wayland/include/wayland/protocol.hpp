...
public:
  ...
  /** @brief This request will cause the server to remap the backing memory
...
public:
  ...
  /** @brief Indicate that the client can accept the given mime type, or
       ...
       */
  void accept(std::uint32_t serial, std::string_view mime_type);

  /** @brief To transfer the offered data, the client issues this request
  ...
  /** @brief Notifies the compositor that the drag destination successfully
  ...
  /** @brief Sets the actions that the destination side client supports for
...
public:
  ...
  /** @brief This request adds a mime type to the set of mime types
        ...
        multiple types.
       */
  void offer(std::string_view mime_type);

  /** @brief Destroy the data source.
   */
  void destroy();

  /** @brief Sets the actions that the source side client supports for this
...
public:
  ...
  /** @brief Start a pointer-driven move of the surface.
  ...
  /** @brief Map the surface relative to an existing surface.
  ...
  /** @brief Set a class for the surface.
...
public:
  ...
  /** @brief Set a buffer as the content of this surface.
  ...
  /** @brief Request a notification when it is a good time to start drawing a new
  ...
  /** @brief This request sets an optional transformation on how the compositor
  ...
  /** @brief This request sets an optional scaling factor on how the compositor
  ...
  /** @brief The x and y arguments specify the location of the new pending
        buffer's upper left corner, relative to the current buffer's upper
        left corner, in surface-local coordinates. In other words, the
        x and y, combined with the new surface size define in which
...
public:
  ...
  /** @brief This describes the transform that a compositor will apply to a
...
public:
  ...
  /** @brief Add the specified rectangle to the region.
   */
  void add(int x, int y, int width, int height);

  /** @brief Subtract the specified rectangle from the region.
   */
...
public:
  ...
  /** @brief Create a sub-surface interface for the given surface, and
...
public:
  ...
  /** @brief This schedules a sub-surface position change.
  ...
  /** @brief This sub-surface is taken from the stack, and put back just
  ...
  /** @brief Change the commit behaviour of the sub-surface to desynchronized
